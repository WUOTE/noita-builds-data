...
RegisterSpawnFunction( 0xffaa42ff, "spawn_electricity_source" )
...
function load_puzzle_capsule_b( x, y )
	print("puzzle capsule spawned at " .. x .. ", " .. y)
	-- be careful where the pixel scene is placed so that electricity source is in a sensible location!
	spawn_electricity_source( x-50, y-230)
	load_random_pixel_scene( g_puzzle_capsule_b, x, y )
end
...
function spawn_electricity_source(x, y)
