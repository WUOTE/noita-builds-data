actions =
{
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/dynamite_unidentified.png",
		related_projectiles	= {"data/entities/projectiles/deck/freezing_gaze.xml"},
		type 		= ACTION_TYPE_PROJECTILE,
		...
		max_uses	= 20,
		action 		= function()
			add_projectile("data/entities/projectiles/deck/freezing_gaze.xml")
			c.fire_rate_wait = c.fire_rate_wait + 20
		end,
	},
	{
	...
	},
	{
		...
		type 		= ACTION_TYPE_UTILITY,
		spawn_level                       = "1,2,4,5,6", -- SUMMON_WANDGHOST
		spawn_probability                 = "0.05,0.08,0.1,0.1,0.1", -- SUMMON_WANDGHOST
		price = 420,
		mana = 300,
		max_uses    = 1, 
		action 		= function()
	...
	},
	{
		...
		type 		= ACTION_TYPE_MATERIAL,
		spawn_level                       = "1,2,3,4,5,6,7", -- TOUCH_WATER
		spawn_probability                 = "0,0,0,0,0.1,0.1,0.1", -- TOUCH_WATER
		price = 420,
		mana = 280,
		max_uses    = 5, 
		action 		= function()
	...
	},
	{
		...
		type 		= ACTION_TYPE_MATERIAL,
		spawn_level                       = "1,2,3,4,5,6,7", -- TOUCH_OIL
		spawn_probability                 = "0,0,0,0,0.1,0.1,0.1", -- TOUCH_OIL
		price = 380,
		mana = 260,
		max_uses    = 5, 
		action 		= function()
	...
	},
	{
		...
		type 		= ACTION_TYPE_MATERIAL,
		spawn_level                       = "1,2,3,4,5,6,7", -- TOUCH_ALCOHOL
		spawn_probability                 = "0,0,0,0,0.1,0.1,0.1", -- TOUCH_ALCOHOL
		price = 360,
		mana = 240,
		max_uses    = 5, 
		action 		= function()
	...
	},
	{
		...
		type 		= ACTION_TYPE_MATERIAL,
		spawn_level                       = "1,2,3,4,5,6,7", -- TOUCH_SMOKE
		spawn_probability                 = "0,0,0,0,0.1,0.1,0.1", -- TOUCH_SMOKE
		price = 350,
		mana = 230,
		max_uses    = 5, 
		action 		= function()
	...
	},
	{
		...
		spawn_probability                 = "0.1,0.1,0.5", -- MANA_REDUCE
		price = 150,
		mana = -100,
	...
	},
	{
		...
		action 		= function()
			...
			for i,v in ipairs( hand ) do
				if ( v.id ~= "DUPLICATE" ) and ( i <= hand_count ) then
					v.action()
				end
			end
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/explosive_projectile_unidentified.png",
		type 		= ACTION_TYPE_PROJECTILE,
		spawn_level                       = "4,5,6", -- TRANSMUTATION
		spawn_probability                 = "0.3,0.3,0.3", -- TRANSMUTATION
		price = 240,
		mana = 120,
		max_uses = 30,
		action 		= function()
	...
	]]--
	{
		...
		spawn_probability                 = "0.3,0.3,0.3", -- BERSERK_FIELD
		price = 200,
		mana = 30,
		max_uses = 15,
		action 		= function()
	...
	},
	{
		...
		spawn_probability                 = "0.3,0.3,0.3,0.3,0.3,0.3,0.3", -- POLYMORPH_FIELD
		price = 200,
		mana = 50,
		max_uses = 5,
		action 		= function()
	...
	},
	{
		...
		spawn_probability                 = "0.3,0.3,0.3,0.3,0.3,0.3", -- CHAOS_POLYMORPH_FIELD
		price = 200,
		mana = 20,
		max_uses = 10,
		action 		= function()
	...
	},
	{
		...
		spawn_probability                 = "0.3,0.3,0.3,0.3", -- ELECTROCUTION_FIELD
		price = 200,
		mana = 60,
		max_uses = 15,
		action 		= function()
	...
	},
	{
		...
		spawn_probability                 = "0.3,0.3,0.3,0.3", -- FREEZE_FIELD
		price = 200,
		mana = 50,
		max_uses = 15,
		action 		= function()
	...
	},
	{
		...
		spawn_probability                 = "0.3,0.3,0.3,0.3,0.3,0.3", -- TELEPORTATION_FIELD
		price = 150,
		mana = 30,
		max_uses = 15,
		action 		= function()
	...
	},
	{
		...
		spawn_probability                 = "0.3,0.3", -- LEVITATION_FIELD
		price = 120,
		mana = 10,
		max_uses = 15,
		action 		= function()
	...
	},
	{
		...
		--max_uses = 150,
		action 		= function()
			c.extra_entities = "data/entities/misc/fizzle.xml,"
	...
	},
	{
		...
		spawn_probability                 = "0.2,0.6,0.6,0.6", -- BOUNCE_EXPLOSION
		price = 180,
		mana = 20,
		--max_uses = 150,
		action 		= function()
	...
	},
	{
		...
		spawn_probability                 = "0.4,0.4,0.4", -- BOUNCE_SPARK
		price = 180,
		mana = 30,
		--max_uses = 150,
		action 		= function()
	...
	},
	{
		...
		action 		= function()
			...
			while ( safety < 100 ) and ( data.recursive ~= nil ) and ( data.recursive == true ) do
	...
	},
	{
		...
		action 		= function()
			...
			while ( safety < 100 ) and ( ( data.type ~= 0 ) or ( ( data.recursive ~= nil ) and ( data.recursive == true ) ) ) do
				rnd = Random( 1, #actions )
				data = actions[rnd]
	...
	},
	{
		...
		action 		= function()
			...
			while ( safety < 100 ) and ( ( data.type ~= 2 ) or ( ( data.recursive ~= nil ) and ( data.recursive == true ) ) ) do
				rnd = Random( 1, #actions )
				data = actions[rnd]
	...
	},
	{
		...
		action 		= function()
			...
			while ( safety < 100 ) and ( ( data.type ~= 1 ) or ( ( data.recursive ~= nil ) and ( data.recursive == true ) ) ) do
				rnd = Random( 1, #actions )
				data = actions[rnd]
	...
	},
	{
		...
		action 		= function()
			...
			while ( data ~= nil ) and ( ( ( data.recursive ~= nil ) and data.recursive ) or ( ( data.uses_remaining ~= nil ) and ( data.uses_remaining == 0 ) ) ) and ( checks < datasize ) do
				rnd = ( rnd % datasize ) + 1
				checks = checks + 1
			...
			if ( data ~= nil ) and ( ( data.recursive == nil ) or ( data.recursive == false ) ) and ( ( data.uses_remaining == nil ) or ( data.uses_remaining > 0 ) ) then
				data.action()
	...
	},
	{
		...
		spawn_probability                 = "0.6,0.6,0.6,1", -- CRITICAL_HIT
		price = 100,
		mana = 10,
		--max_uses = 50,
		action 		= function()
			...
			if ( data ~= nil ) then
				while ( #deck >= how_many ) and ( data.type == 2 ) do
					if ( ( data.uses_remaining == nil ) or ( data.uses_remaining > 0 ) ) then
	...
	},
	{
		...
		spawn_probability                 = "0.1,0.1,0.2,0.2,0.2", -- FIREBALL_RAY
		price = 260,
		mana = 100,
		--max_uses = 20,
		action 		= function()
	...
	},
	{
		...
		spawn_requires_flag = "card_unlocked_alchemy",
		type 		= ACTION_TYPE_MODIFIER,
		spawn_level                       = "10", -- FIREBALL_RAY
		spawn_probability                 = "0.1", -- FIREBALL_RAY
		price = 300,
		mana = 150,
		--max_uses = 20,
		action 		= function()
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/bomb_unidentified.png",
		related_projectiles	= {"data/entities/projectiles/deck/meteor_green.xml"},
		...
		action 		= function()
			...
			for i,v in ipairs( players ) do
				local x,y = EntityGetTransform( v )
				local eid = EntityLoad("data/entities/projectiles/deck/meteor_rain.xml", x, y)
				EntityAddChild( v, eid )
			end
			c.extra_entities = c.extra_entities .. "data/entities/projectiles/deck/meteor_rain.xml,"
			c.fire_rate_wait = c.fire_rate_wait + 100
			current_reload_time = current_reload_time + 60
		end,
	},
