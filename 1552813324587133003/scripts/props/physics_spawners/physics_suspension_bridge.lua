function raytrace( x0, y0, x_direction, max_length )
	...
	if( min_x == x0 ) then min_x = -max_length end
	if( max_x == x0 ) then max_x = max_length end
...
function do_suspension_bridge()
	...
	-- print( min_x )
	-- print( max_x )
	-- fuck this shit, why can't I work in peace for 5 minutes lgjergopjerg piejgiejrgpijgergpoi
