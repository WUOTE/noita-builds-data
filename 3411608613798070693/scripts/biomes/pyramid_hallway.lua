...
function init( x, y, w, h )
	LoadPixelScene( "data/biome_impl/pyramid/hallway.png", "data/biome_impl/pyramid/hallway_visual.png", x, y, "data/biome_impl/pyramid/hallway_background.png", true )
end
...
g_pixel_scene_01 =
{
	...
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/crypt/plateroom.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/plateroom_background.png",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
	...
	},
	{
		...
		visual_file		= "data/biome_impl/crypt/mining_visual.png",
		background_file	= "",
		is_unique		= 0
	},
}
