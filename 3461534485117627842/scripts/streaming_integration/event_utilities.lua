...
-- this is called on PRIVMSG and USERSTATE irc commands.
-- can be used to implement custom message handling. please note that 'message' and 'raw' have been decoded to include only characters in the ascii 0-255 range.
