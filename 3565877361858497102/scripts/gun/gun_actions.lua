actions =
{
	...
	},
	{
		...
		spawn_probability                 = "1,1,1", -- DISC_BULLET_BIG
		price = 180,
		mana = 38,
		--max_uses = 40,
		action 		= function()
			...
			c.spread_degrees = c.spread_degrees + 1.7
			shot_effects.recoil_knockback = shot_effects.recoil_knockback + 20.0
		end,
	},
	{
	...
	},
	{
		...
		action 		= function()
			...
			c.fire_rate_wait = math.max( c.fire_rate_wait - 12, 0 )
		end,
	},
	--[[
	{
	...
	},
	{
		...
		action 		= function()
			...
			c.fire_rate_wait = c.fire_rate_wait + 10
			c.speed_multiplier = math.max( c.speed_multiplier - 2, 0 )
		end,
	},
	{
		id          = "DELAYED_SPELL",
	...
	},
	{
		...
		type 		= ACTION_TYPE_PROJECTILE,
		spawn_level                       = "0,1,2,4,5,6", -- TELEPORT_PROJECTILE
		spawn_probability                 = "0.05,0.05,0.05,0.05,0.05,0.05", -- TELEPORT_PROJECTILE
		price = 100,
		mana = 5,
		--max_uses = -1,
		action 		= function()
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/rocket_unidentified.png",
		type 		= ACTION_TYPE_UTILITY,
		spawn_level                       = "1,2,4,5,6", -- ROCKET
		spawn_probability                 = "0.05,0.08,0.1,0.1,0.1", -- ROCKET -- ROCKET
		price = 420,
		mana = 300,
		max_uses    = 1, 
		action 		= function()
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/rocket_unidentified.png",
		type 		= ACTION_TYPE_MATERIAL,
		spawn_level                       = "1,2,3,4,5,6,7", -- ROCKET
		spawn_probability                 = "0,0,0,0,0.1,0.1,0.1", -- ROCKET
		price = 480,
		mana = 300,
		max_uses    = 1, 
		action 		= function()
	...
	},
	{
		...
		mana = 2,
		action 		= function()
			c.fire_rate_wait = math.max(c.fire_rate_wait - 7, 0)
			current_reload_time = math.max(current_reload_time - 15, 0)
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/spread_reduce_unidentified.png",
		type 		= ACTION_TYPE_MODIFIER,
		spawn_level                       = "3,4,5,6", -- SPREAD_REDUCE
		spawn_probability                 = "1,1,1,1", -- SPREAD_REDUCE
		price = 250,
		mana = 40,
		--max_uses = 150,
	...
	},
	{
		...
		spawn_probability                 = "1,1,1,1,6", -- BOUNCE
		price = 50,
		mana = 0,
		--max_uses = 150,
		action 		= function()
	...
	},
	{
		...
		spawn_probability                 = "0.5,0.5,0.5,0.5,0.5", -- HOMING
		price = 220,
		mana = 70,
		--max_uses = 100,
		action 		= function()
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/explosive_projectile_unidentified.png",
		type 		= ACTION_TYPE_MODIFIER,
		spawn_level                       = "2,3,4,5", -- EXPLOSIVE_PROJECTILE
		spawn_probability                 = "1,1,1,1", -- EXPLOSIVE_PROJECTILE
		price = 80,
		mana = 20,
		--max_uses = 50,
		action 		= function()
	...
	},
	{
		...
		type 		= ACTION_TYPE_MODIFIER,
		spawn_level                       = "0,1,2,3,4", -- EXPLOSIVE_PROJECTILE
	...
	},]]--
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/sinewave_unidentified.png",
		type 		= ACTION_TYPE_MODIFIER,
		spawn_level                       = "1,2,3,4", -- BOUNCE_EXPLOSION
		spawn_probability                 = "1,1,1,1", -- BOUNCE_EXPLOSION
		price = 200,
		mana = 90,
		action 		= function()
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/electric_charge_unidentified.png",
		type 		= ACTION_TYPE_MODIFIER,
		spawn_level                       = "1,2,3,4,5", -- ELECTRIC_CHARGE
		spawn_probability                 = "0,0,1,1,1", -- ELECTRIC_CHARGE
		price = 260,
		mana = 110,
		max_uses = 16,
		custom_xml_file = "data/entities/misc/custom_cards/electric_charge.xml",
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/electric_charge_unidentified.png",
		type 		= ACTION_TYPE_MODIFIER,
		spawn_level                       = "2,3,4,5,6", -- ELECTRIC_CHARGE
		spawn_probability                 = "1,1,1,1,1", -- ELECTRIC_CHARGE
		price = 280,
		mana = 130,
		max_uses = 20,
		action 		= function()
	...
	},]]--	
	{
		...
		mana = 1,
		action 		= function()
			add_projectile("data/entities/projectiles/deck/ocarina_a.xml")
			c.fire_rate_wait = c.fire_rate_wait + 15
		end,
	},
	{
		...
		mana = 1,
		action 		= function()
			add_projectile("data/entities/projectiles/deck/ocarina_b.xml")
			c.fire_rate_wait = c.fire_rate_wait + 15
		end,
	},
	{
		...
		mana = 1,
		action 		= function()
			add_projectile("data/entities/projectiles/deck/ocarina_c.xml")
			c.fire_rate_wait = c.fire_rate_wait + 15
		end,
	},
	{
		...
		mana = 1,
		action 		= function()
			add_projectile("data/entities/projectiles/deck/ocarina_d.xml")
			c.fire_rate_wait = c.fire_rate_wait + 15
		end,
	},
	{
		...
		mana = 1,
		action 		= function()
			add_projectile("data/entities/projectiles/deck/ocarina_e.xml")
			c.fire_rate_wait = c.fire_rate_wait + 15
		end,
	},
	{
		...
		mana = 1,
		action 		= function()
			add_projectile("data/entities/projectiles/deck/ocarina_f.xml")
			c.fire_rate_wait = c.fire_rate_wait + 15
		end,
	},
	{
		...
		mana = 1,
		action 		= function()
			add_projectile("data/entities/projectiles/deck/ocarina_gsharp.xml")
			c.fire_rate_wait = c.fire_rate_wait + 15
		end,
	},
	{
		...
		mana = 1,
		action 		= function()
			add_projectile("data/entities/projectiles/deck/ocarina_a2.xml")
			c.fire_rate_wait = c.fire_rate_wait + 15
		end,
	},
}