...
g_furniture =
{
	...
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/snowcastle/furniture_bunk.png",
		visual_file		= "data/biome_impl/snowcastle/furniture_bunk_visual.png",
		background_file	= "",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/snowcastle/furniture_locker.png",
		visual_file		= "data/biome_impl/snowcastle/furniture_locker_visual.png",
		background_file	= "",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/snowcastle/furniture_footlocker.png",
		visual_file		= "data/biome_impl/snowcastle/furniture_footlocker_visual.png",
		background_file	= "",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/snowcastle/furniture_table.png",
		visual_file		= "data/biome_impl/snowcastle/furniture_table_visual.png",
		background_file	= "",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/snowcastle/furniture_stool.png",
		visual_file		= "data/biome_impl/snowcastle/furniture_stool_visual.png",
		background_file	= "",
		is_unique		= 0
	},
	{
		prob   			= 0.5,
		material_file 	= "data/biome_impl/snowcastle/furniture_cryopod.png",
		visual_file		= "data/biome_impl/snowcastle/furniture_cryopod_visual.png",
		background_file	= "",
		is_unique		= 0
	},
}
...
function load_furniture( x, y )
	if ProceduralRandomf(x,y) < 0.002 then
		...
		load_random_pixel_scene(g_furniture, x, y-15)
	end
end
...
function load_furniture_bunk( x, y )
	if ProceduralRandomf(x,y) < 0.02 then
		...
		LoadPixelScene( "data/biome_impl/snowcastle/furniture_bunk.png", "data/biome_impl/snowcastle/furniture_bunk_visual.png", x, y-15, "", true )
	end
end

function load_bunk_with_surprise( x,y )
	LoadPixelScene( "data/biome_impl/snowcastle/furniture_bunk.png", "data/biome_impl/snowcastle/furniture_bunk_visual.png", x, y-15, "", true )
	EntityLoad("data/entities/props/physics_propane_tank.xml", x+12, y)
end
