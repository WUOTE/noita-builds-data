...
function spawn_pillars( x, y )
	...
	local flags = 
	{
		...
		{ { "miniboss_dragon", "minid" }, { "miniboss_limbs", "minil" }, { "miniboss_ghost", "minigh" }, { "miniboss_pit", "minip" }, { "miniboss_alchemist", "minia" }, { "miniboss_robot", "minir" }, { "miniboss_wizard", "meme" }, { "miniboss_maggot", "maggot" }, { "miniboss_gate_monsters", "minigm" }, { "boss_centipede", "boss" } },
