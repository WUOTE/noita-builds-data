actions =
{
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/lightning_unidentified.png",
		related_projectiles	= {"data/entities/projectiles/deck/ball_lightning.xml"},
		type 		= ACTION_TYPE_PROJECTILE,
	...
	{	
		...
		type 		= ACTION_TYPE_UTILITY,
		spawn_level                       = "1,2,4,5,6,10", -- SUMMON_WANDGHOST
		spawn_probability                 = "0.05,0.08,0.1,0.1,0.1,0.1", -- SUMMON_WANDGHOST
		price = 420,
		mana = 300,
		max_uses    = 1, 
		never_unlimited = true,
	...
	},
	{
		...
		spawn_probability                 = "0.5,0.5,0.5,0.5,1", -- LIFETIME_DOWN
		price = 50,
		mana = 1,
		--max_uses = 150,
		action 		= function()
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/spread_reduce_unidentified.png",
		spawn_requires_flag = "card_unlocked_disabled",
		type 		= ACTION_TYPE_OTHER,
		spawn_manual_unlock = true,
		recursive	= true,
		spawn_level                       = "5,6,10", -- MANA_REDUCE
