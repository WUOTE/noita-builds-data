...
function perk_spawn( x, y, perk_id )
	...
	local perk_fulltitle = GameTextGet( "$log_perk_fulltitle", GameTextGetTranslatedOrNot( perk_data.ui_name ), GameTextGetTranslatedOrNot( perk_data.ui_description ) )
