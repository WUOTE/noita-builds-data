...
g_pixel_scene_02 =
{
	...
	{
		prob   			= 0.5,
		material_file 	= "data/biome_impl/excavationsite/mechanism.png",
		visual_file		= "",
		background_file	= "data/biome_impl/excavationsite/mechanism_background.png",
		is_unique		= 0
	},
	{
		prob   			= 0.5,
		material_file 	= "data/biome_impl/excavationsite/mechanism.png",
		visual_file		= "",
		background_file	= "data/biome_impl/excavationsite/mechanism_background2.png",
		is_unique		= 0
	},
	{
		prob   			= 0.5,
		material_file 	= "data/biome_impl/excavationsite/mechanism.png",
		visual_file		= "",
		background_file	= "data/biome_impl/excavationsite/mechanism_background3.png",
		is_unique		= 0
	},
}
