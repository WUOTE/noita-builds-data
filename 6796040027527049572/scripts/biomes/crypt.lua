...
g_background_scenes =
{
	...
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/pillars_01_background.png",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/pillars_02_background.png",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/pillars_03_background.png",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/alcove_01_background.png",
		is_unique		= 0
	},
	{
		prob   			= 2.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/alcove_02_background.png",
		is_unique		= 0
	},
	{
		prob   			= 2.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/alcove_03_background.png",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/alcove_04_background.png",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/alcove_05_background.png",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/alcove_06_background.png",
		is_unique		= 0
	},
}
...
g_small_background_scenes =
{
	...
	},
	{
		...
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/slab_01_background.png",
		is_unique		= 0
	},
	{
		prob   			= 0.5,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/slab_02_background.png",
		is_unique		= 0
	},
	{
		prob   			= 0.5,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/slab_03_background.png",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/slab_04_background.png",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/slab_05_background.png",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/slab_06_background.png",
		is_unique		= 0
	},
	{
		prob   			= 1.0,
		material_file 	= "data/biome_impl/blank.png",
		visual_file		= "",
		background_file	= "data/biome_impl/crypt/slab_07_background.png",
		is_unique		= 0
	},
}
...
function load_background_scene( x, y )
	load_random_pixel_scene( g_background_scenes, x+5, y )
end

function load_small_background_scene( x, y )
	load_random_pixel_scene( g_small_background_scenes, x, y )
end
