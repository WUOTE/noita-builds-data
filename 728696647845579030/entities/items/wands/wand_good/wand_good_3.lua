...
gun.actions_per_round = {6,8}
gun.reload_time = {24,38}
gun.shuffle_deck_when_empty = 0
gun.fire_rate_wait = {10,22}
gun.spread_degrees = {3,8}
gun.speed_multiplier = 1.5
gun.mana_charge_speed = {160,240}
gun.mana_max = {1200,1500}
gun.actions = {"GRENADE_TIER_3","ROCKET_TIER_3","METEOR","BULLET_HEAVY"}
...
ComponentObjectSetValue( ability_comp, "gun_config", "actions_per_round", get_random_between_range( gun.actions_per_round ) )
