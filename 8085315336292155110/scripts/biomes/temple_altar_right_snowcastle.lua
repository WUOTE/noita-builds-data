...
function init( x, y, w, h )
	...
	LoadPixelScene( "data/biome_impl/temple_altar_right_snowcastle.png", "data/biome_impl/temple_altar_right_visual.png", x, y-40+300, "data/biome_impl/temple_altar_right_background.png", true )
end
