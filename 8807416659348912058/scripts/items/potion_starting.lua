...
function potion_a_materials()
	...
	elseif( r_value <= 80 ) then
		return "blood"
	elseif( r_value <= 97 ) then
		return random_from_array( { "acid", "gunpowder_unstable", "magic_liquid_polymorph", "magic_liquid_random_polymorph", "magic_liquid_berserk", "magic_liquid_charm","magic_liquid_movement_faster" } )
	else
