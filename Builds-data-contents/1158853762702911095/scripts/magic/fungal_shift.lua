...
materials_from = 
{
	...
	{ probability = 1.0, materials = { "radioactive_liquid" } },
	{ probability = 1.0, materials = { "oil" } },
	...
	{ probability = 1.0, materials = { "blood_fungi" } },
	{ probability = 1.0, materials = { "blood_cold" } },
	{ probability = 1.0, materials = { "acid" } },
	{ probability = 1.0, materials = { "magic_liquid_polymorph" } },
	{ probability = 1.0, materials = { "magic_liquid_teleportation" } },
	{ probability = 0.1, materials = { "fungi" } },
}
