...
function item_pickup( entity_item, entity_who_picked, name )
	...
	if( fight_player ) then
		...
		EntityLoad("data/entities/animals/boss_centipede/loose_lavaceiling.xml", x-235, y-75)
		EntityLoad("data/entities/animals/boss_centipede/loose_lavaceiling.xml", x+264, y-52)
		EntityLoad("data/entities/animals/boss_centipede/loose_lavabridge.xml", x-235, y+280)
		EntityLoad("data/entities/animals/boss_centipede/loose_lavabridge.xml", x+257, y+260)
