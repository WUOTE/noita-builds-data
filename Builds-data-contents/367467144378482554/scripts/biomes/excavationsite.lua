...
function spawn_ladder(x, y)
	--LoadPixelScene( "data/biome_impl/excavationsite/ladder_long.png", "data/biome_impl/excavationsite/ladder_long_visual.png", x-5, y-83, "", true )
...
function generate_tower( x, y, height )
	if ProceduralRandom(x,y) > 0.75 then return end

	y = y + 15

	-- bottom
	LoadBackgroundSprite("data/biome_impl/excavationsite/tower_bottom_1.png", x, y, 40)
	y = y - 60
	-- middle parts
	for i=1, height do
...
function spawn_beam_low(x,y)
	LoadBackgroundSprite("data/biome_impl/excavationsite/beam_low.png", x-60, y-35, 60)
end

function spawn_beam_low_flipped(x,y)
	LoadBackgroundSprite("data/biome_impl/excavationsite/beam_low_flipped.png", x-60, y-35, 60)
end

function spawn_beam_steep(x,y)
	LoadBackgroundSprite("data/biome_impl/excavationsite/beam_steep.png", x-35, y-60, 60)
end

function spawn_beam_steep_flipped(x,y)
	LoadBackgroundSprite("data/biome_impl/excavationsite/beam_steep_flipped.png", x-35, y-60, 60)
end
