...
function spawn_pillars( x, y )
	...
	local flags = 
	{
		{ { "misc_chest_rain", "crain" }, { "misc_worm_rain", "wrain" }, { "misc_greed_rain", "grain" }, { "misc_altar_tablet", "train" }, { "misc_monk_bots", "mbots" }, { "secret_tower", "secrett" } },
		...
		{ { "progress_ending0", "end0" }, { "progress_ending_toxic", "endt" }, { "progress_ending_gold", "endb" }, { "progress_ending2", "endg" }, { "progress_newgameplusplus3", "endp" }, { "progress_nightmare", "endn" } },
