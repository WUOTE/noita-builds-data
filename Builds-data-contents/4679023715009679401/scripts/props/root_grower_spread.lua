...
edit_component2( entity_id, "VelocityComponent", function(comp,vars)
	...
	for i=0, 2 do
		...
		local did_hit,hit_x,hit_y = RaytraceSurfaces(pos_x + sensor_x * 8, pos_y + sensor_y * 8, pos_x + sensor_x * sensor_distance, pos_y + sensor_y * sensor_distance)
		if did_hit then
