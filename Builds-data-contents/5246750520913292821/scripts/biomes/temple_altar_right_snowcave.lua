...
function spawn_areachecks( x, y )
	...
	if( temple_should_we_spawn_checkers() ) then
		EntityLoad( "data/entities/buildings/temple_areacheck_horizontal.xml", x - 190, y - 69 )
		...
		EntityLoad( "data/entities/buildings/temple_areacheck_vertical_stub.xml", x + 69, y - 69 )
