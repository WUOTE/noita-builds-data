...
function do_money_drop( amount_multiplier )
	...
	while money >= 10 and nugget_10_count < 5 do
		EntityLoad( "data/entities/items/pickup/goldnugget_10.xml", x, y-8 )
		money = money - 10
	...
	while money >= 10000 do
		EntityLoad( "data/entities/items/pickup/goldnugget_10000.xml", x, y-8 )
		money = money - 10000
	end	

	while money >= 1000 do
		EntityLoad( "data/entities/items/pickup/goldnugget_1000.xml", x, y-8 )
		money = money - 1000
	end	

	while money >= 200 do
		EntityLoad( "data/entities/items/pickup/goldnugget_200.xml", x, y-8 )
		money = money - 200
	end	

	while money >= 50 do
		EntityLoad( "data/entities/items/pickup/goldnugget_50.xml", x, y-8 )
		money = money - 50
	end	
