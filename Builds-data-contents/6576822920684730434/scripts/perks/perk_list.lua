		...
		func = function( entity_perk_item, entity_who_picked, item_name )
			...
			if ( wand ~= NULL_ENTITY ) then
				...
				if ( comp ~= nil ) then
					...
					mana_max = mana_max + Random( 10, 20 ) * Random( 10, 20 )
					mana_charge_speed = mana_charge_speed * Random( 150, 350 ) * 0.01
					
					deck_capacity = math.floor( deck_capacity * 0.5 )
