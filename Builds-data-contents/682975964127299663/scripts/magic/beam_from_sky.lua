...
async(function ()
	...
	GameScreenshake( 200 )
	component_write( EntityGetFirstComponent( entity_id, "ParticleEmitterComponent"), { count_min=1000, count_max=2000, cosmetic_force_create=true, render_ultrabright=true } ) 
end)