...
function init( x, y, w, h )
	...
	LoadPixelScene( "data/biome_impl/temple_altar_right.png", "data/biome_impl/temple_altar_right_visual.png", x, y-40+300, "data/biome_impl/temple_altar_right_background.png", true )
	LoadPixelScene( "data/biome_impl/temple_altar_right_extra.png", "", x, y-40+300+282, "", true )
end
