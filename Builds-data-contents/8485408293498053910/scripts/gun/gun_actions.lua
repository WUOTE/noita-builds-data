actions =
{
	...
	{
		id          = "LASER_SABRE",
		name 		= "$action_laser_sabre",
		description = "$actiondesc_laser_sabre",
		sprite 		= "data/ui_gfx/gun_actions/laser_sabre.png",
		sprite_unidentified = "data/ui_gfx/gun_actions/chainsaw_unidentified.png",
		type 		= ACTION_TYPE_PROJECTILE,
		spawn_level                       = "0,2", -- CHAINSAW
		spawn_probability                 = "1,1", -- CHAINSAW
		...
		sound_loop_tag = "sound_digger",
		action 		= function()
			add_projectile("data/entities/projectiles/deck/laser_sabre.xml")
			c.fire_rate_wait = math.max( 0, c.fire_rate_wait - 35 )
			current_reload_time = current_reload_time - ACTION_DRAW_RELOAD_TIME_INCREASE - 10 -- this is a hack to get the digger reload time back to 0
		end,
	},
	{
		id          = "LASER_SABRE_TIMER",
		name 		= "$action_laser_sabre_timer",
		description = "$actiondesc_laser_sabre_timer",
		sprite 		= "data/ui_gfx/gun_actions/laser_sabre_timer.png",
		sprite_unidentified = "data/ui_gfx/gun_actions/chainsaw_unidentified.png",
		type 		= ACTION_TYPE_PROJECTILE,
		spawn_level                       = "0,2", -- CHAINSAW
		spawn_probability                 = "1,1", -- CHAINSAW
		...
		sound_loop_tag = "sound_digger",
		action 		= function()
			add_projectile_trigger_timer("data/entities/projectiles/deck/laser_sabre.xml",4,1)
			c.fire_rate_wait = math.max( 0, c.fire_rate_wait - 35 )
			current_reload_time = current_reload_time - ACTION_DRAW_RELOAD_TIME_INCREASE - 10 -- this is a hack to get the digger reload time back to 0
		end,
	},
	...
	},
	{
		...
		mana = 100, 
		max_uses    = 3, 
		custom_xml_file = "data/entities/misc/custom_cards/rock.xml",
		action 		= function()
